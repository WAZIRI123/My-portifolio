		...
		<div class="margin-top">
			<div class="row">	
								<div class="alert alert-info">
                                    ...
                                    <strong><i class="icon-user icon-large"></i>&nbsp;Case Table</strong>
                                </div>

		<div class="span12">		

		<form method="post" action="pending_save.php">
<div class="span3">
				...
				<div class="control-group"> 
					<div class="controls">
								...
								<button name="delete_other" class="btn btn-success"><i class="icon-plus-sign icon-large"></i>Save</button>
					</div>
				</div>
				</div>
				<div class="span8">
						<div class="alert alert-success"><strong>Select Camera</strong></div>
                            <table cellpadding="0" cellspacing="0" border="0" class="table" id="example">
                                ...
                                <tbody>
                                  ...
                                  <?php  $user_query=mysqli_query($conn,"select * from Camera where status != 'Archive' ")or die(mysqli_error());
...
$(".uniform_on").change(function(){
    ...
    if( $(".uniform_on:checked").length == max ){
        ...
        $(".uniform_on").attr('disabled', 'disabled');
		         alert('3 Camera are allowed per borrow');
