<div class="navbar navbar-fixed-top navbar-inverse">
            <div class="navbar-inner">
                <div class="container">
					...
					<li>		
					<a href=""  data-toggle="dropdown" ><i class="icon-file icon-large"></i> CasesRecord</a>
					<ul class="dropdown-menu">
					<li><a href="change_password.php"><i class="icon-pencil icon-large"></i>&nbsp;RecordCase</a></li>
					<li><a href="Approve.php"><i class="icon-cog icon-large"></i>&nbsp;RecordCase</a></li>
					</ul>
					</li>
					
					<li><a href="Camera.php"><i class="icon-book icon-large"></i>&nbsp;Cameras</a></li>
					<li><a href="client.php"><i class="icon-group icon-large"></i>&nbsp;</a></li>
