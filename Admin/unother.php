			...
			<div class="span12">	
                            <table cellpadding="0" cellspacing="0" border="0" class="table  table-bordered" id="example">
                                <div class="alert alert-info">
                                    ...
                                    <strong><i class="icon-user icon-large"></i>&nbsp;Unconfirmed Clients Table</strong>
                                </div>
                                ...
                                <tbody>
                                  ...
                                  <?php  $user_query=mysqli_query($conn,"select * from other where status = 'unactive' ")or die(mysqli_error());
									while($row=mysqli_fetch_array($user_query)){
									$id=$row['other_id'];  ?>
									<tr class="del<?php echo $id ?>">
                                    <td><?php echo $row['other_no']; ?></td> 
