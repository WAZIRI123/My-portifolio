...
<?php $get_id = $_GET['id']; ?>
    <div class="container">
		<div class="margin-top">
			...
			<div class="span12">	
		<?php 
		$query=mysqli_query($conn,"select * from client where client_id='$get_id'")or die(mysqli_error());
		$row=mysqli_fetch_array($query);
		
		?>
             <div class="alert alert-info"><i class="icon-pencil"></i>&nbsp;Edit client</div>
			<p><a class="btn btn-info" href="client.php"><i class="icon-arrow-left icon-large"></i>&nbsp;Back</a></p>
	<div class="addother">
	<div class="details">Please Enter Details Below</div>	
	<form class="form-horizontal" method="POST" action="update_client.php" enctype="multipart/form-data">
